                  ...
                  <div x-show="form_4">
                    ...
                    <div class="form-check">
                      <input
                        ...
                        value="lengkap"
                      />
                      <label class="form-check-label" for="orangtua1">
                        Lengkap
                      </label>
                    </div>
                    <div class="form-check">
                      <input
                        ...
                        value="bapak"
                      />
                      <label class="form-check-label" for="orangtua2">
                        Bapak
                      </label>
                    </div>
                    <div class="form-check">
                      <input
                        ...
                        value="ibu"
                      />
                      <label class="form-check-label" for="orangtua3">
                        Ibu
                      </label>
                    </div>
                    <div class="form-check">
                      <input
                        ...
                        value="yatim-piatu"
                      />
                      <label class="form-check-label" for="orangtua4">
                        Yatim Piatu
                      </label>
                    </div>
                    </div>
