      ...
      @if ( isset($biodata2) )
          <div class="card-body">
            ...
            @if (isset($biodata2->user->quis) || isset($biodata2->user->video))
                <div class="row mt-4">
                    <div class="col">
                    <h6 class="section-title">Nilai</h6>
                        <table cellpadding="5">
                            <tr>
            ...
            <div class="row mt-4">
                <div class="col">
                <h6 class="section-title">Biodata Orang Tua</h6>
                    <table cellpadding="5">
                        <tr>
            ...
            <div class="row mt-4">
                <div class="col">
                <h6 class="section-title">Pertanyaan 1</h6>
                    <table cellpadding="5">
                        <tr>
            ...
            <div class="row mt-4">
                <div class="col">
                <h6 class="section-title">Pertanyaan 2</h6>
                    <table cellpadding="5">
                        <tr>
            ...
            <div class="row mt-4">
                <div class="col">
                <h6 class="section-title">Pertanyaan 3</h6>
                    <table cellpadding="5">
                        <tr>
      ...
      @else
        <div class="text-center min-vh-100 pt-5">
            <div class="mt-5 pt-5">
                ...
                <a href="{{ route('tahap-kedua') }}" class="btn btn-sm btn-info px-4 my-4"><i class="fas fa-arrow-left"></i> ikuti tes sekarang</a>
            </div>
        </div>
      @endif
    </div>
