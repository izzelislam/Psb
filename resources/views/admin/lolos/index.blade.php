      ...
      $("#filter").fireModal({
        ...
        body: `
          <form method="GET">
            ...
            <button type="submit" formaction="{{ route('lolos.index') }}" class="btn btn-primary">Terapkan</button>
            <button type="submit" formaction="{{ route('lolos-filter.reset') }}" class="btn btn-primary float-right">Atur Ulang</button>
