...
@section('title','Daftar Data Link Video')

@section('title-page','Data Link Video')

@section('bread-crumb')
    <div class="section-header-breadcrumb">
        <div class="breadcrumb-item active"><a href="#">Data Link Video</a></div>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                      <div class="row mb-3 justify-content-between">
                        ...
                        <form method="POST">
                        @csrf
                        <button  formaction="{{ route('video-lolos.all') }}" id="lol2" class="d-none">lolos</button>
                        <button  formaction="{{ route('video-tidak-lolos.all') }}" id="nl2" class="d-none">lolos</button>
                        <button  formaction="{{ route('video-hapus.all') }}" id="hp2" class="d-none">lolos</button>
                          ...
                          <tr class="
                              ...
                              <td>
                                @if ($item->status == null)
                                  ...
                                  <button formaction="{{ route('video.lolos', $item->id ) }}" class="btn btn-success btn-sm btn-icon icon-left"> <i class="fas fa-check"></i> Lolos</button>

                                  <button formaction="{{ route('video-tidak.lolos', $item->id ) }}" class="btn btn-warning btn-sm btn-icon icon-left"> <i class="fas fa-times"></i> Tidak</button>
                              
                                @endif
                                  <button formaction="{{ route('video.hapus', $item->id ) }}" class="btn btn-danger btn-sm btn-icon icon-left"> <i class="fas fa-trash"></i> delete</button>
                              </td>
                          </tr>
                          @endforeach
                          </tbody>
